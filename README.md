...
3.  **Use the App:**
    * The application is fully functional on the **web**. Open it in your browser at [![Netlify Status](https://api.netlify.com/api/v1/badges/ffaf6e98-2279-4f0f-895a-fbdd255bc426/deploy-status)](https://app.netlify.com/projects/sunny-florentine-b9e9cf/deploys).
